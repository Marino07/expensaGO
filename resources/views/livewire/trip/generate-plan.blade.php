                ...
                @foreach($plan as $index => $dayPlan)
                    <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                        <div class="bg-gradient-to-r from-blue-500 to-indigo-600 px-6 py-4">
                            <h3 class="text-xl font-semibold text-white">Day {{ $index + 1 }}: {{ $dayPlan['day'] }}</h3>
                        </div>
                        <div class="p-6">
                            <div class="md:flex">
                                @if($dayPlan['image_url'])
                                    <div class="md:flex-shrink-0">
                                        <img src="{{ $dayPlan['image_url'] }}" alt="{{ $dayPlan['attraction'] }}" class="h-48 w-full object-cover md:w-48">
                                    </div>
                                @endif
                                <div class="mt-4 md:mt-0 md:ml-6">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="flex items-center mt-2">
                                            ...
                                            <span class="text-gray-600">Walking time: {{ $dayPlan['walking_time'] }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
